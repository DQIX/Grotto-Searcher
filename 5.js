...
function openh3Modal() { openGenericModal('h3Modal', 'h3', '#0ca', '#055', '#001a1a', '#559988', '#003333'); }
function closeh3Modal() { document.getElementById('h3Modal').style.display='none'; }
function switchH3Tab(lang) { switchGenericTab('h3', lang, '#0ca', '#055', '#001a1a', '#559988', '#003333'); }
